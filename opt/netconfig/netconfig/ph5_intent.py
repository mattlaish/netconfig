...
class DesiredStateStatus(str, Enum):
    DRAFT="DRAFT"; PUBLISHED="PUBLISHED"; ACTIVE="ACTIVE"; SUPERSEDED="SUPERSEDED"; ARCHIVED="ARCHIVED"

class IntentStatus(str, Enum):
    DRAFT="DRAFT"; VALIDATING="VALIDATING"; PLANNED="PLANNED"; APPROVAL_PENDING="APPROVAL_PENDING"; APPROVED="APPROVED"; EXECUTING="EXECUTING"; VERIFIED="VERIFIED"; FAILED="FAILED"; ROLLED_BACK="ROLLED_BACK"
